...
public class ProjectApplication {
    ...
    CommandLineRunner init(UserRepository userRepository,ConfRepository confRepository) {
        return args -> {
        	Conf conf = new Conf("Spring conf",new String[]{"vip: 100ву","normal: 10ву"},"1-2-2020",new String[]{"vip: 200ву","normal: 100ву"},
        			"3-3-2020","test") ;
        	Conf conf2 = new Conf("Spring conf2",new String[]{"vip: 30ву","normal: 20ву"},"1-2-2020",new String[]{"vip: 200ву","normal: 100ву"},"3-3-2020","test");
        	...
        	/* initialisation de la base de donnижe*/
        	String n = " test ";
